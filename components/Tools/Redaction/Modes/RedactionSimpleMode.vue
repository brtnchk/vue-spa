<template>
  <section v-if="hasContent" class="tool" id="tool">
    <div class="simple-mode">
      <div :style="{'padding-top': 0}" class="tool__wrapper">
    ...
    <SimpleToolControl
      ...
      :collectStatistics="collectStatistics"></SimpleToolControl>
  </section>
...
<script>
  ...
  import SimpleToolControl from '../Controls/Tools/SimpleToolControl.vue';
  import ContentControl from '../Controls/Content/ContentControl.vue';

  export default {
    name: 'RedactionSimpleMode',
    components: {
      SimpleToolControl,
      ContentControl
    },
