  ...
  <div class="section__wrapper-right">
    ...
    <div class="bill">
      <div class="bill__wrapper">
        ...
        <div v-else class="bill__row bill__row-8 bill__row--block">
          <NoteFlashcardItem
            ...
            :item="item"
            :index="index"
            ref="cards"></NoteFlashcardItem>
          <AddNewFlashcardItem
            @add="onAddNoteItem"
            :itemCount="itemCount"></AddNewFlashcardItem>
        </div>
        ...
        <div class="bill__row bill__row-5 bill__row--btn">
          <a
            @click.prevent="updateNote({currentNote, currentNoteItems})"
...
<script>
  ...
  import NoteFlashcardItem from '../NoteItems/NoteItemsEdit/NoteFlashcardItem.vue';
  import AddNewFlashcardItem from '../NoteItems/NoteItemsAdd/AddNewFlashcardItem.vue';
  import DownloadImage from '../../Controls/DownloadImage.vue';
  ...
  export default {
    ...
    created() {
      this.currentNote.type = 'flashcard';
